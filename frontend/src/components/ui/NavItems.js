...
<div className="flex sm:space-x-2 space-x-1  text-center mt-2 px-3 py-2">
 ...
 <div className="flex sm:space-x-2 space-x-1  text-center mt-2 px-3 py-2">
  ...
  <h1 className="text-gray-800 bg-pink-200 rounded  font-normal text-sm ">10.00</h1>
      ...
      <div className="px-2">
        <Link className="bg-gradient-to-br from-pink-500 to-red-600  md:border border-transparent text-white sm:text-md text-xs px-3 leading-tight py-2  rounded-lg transition-colors ease-in-out duration-150">
          {accounts[0]}</Link>
      </div>
